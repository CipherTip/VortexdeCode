...
namespace VortexdeCodeDL.RepositoryContext
{
    public class GenericRepositoryContext<T> : VortexDBContext, IGenericRepositoryContext<T> where T : class
    {
        //public GenericRepositoryContext(VortexDBContext databaseContext)
        //    : base(databaseContext)
        //{

        //}
        public GenericRepositoryContext(DbContextOptions<VortexDBContext> options)
            : base(options)
        {
